const k3Data = {
	l0: [
		{ name: "Volkswagen, Honda, Fiat, Peugeot, Volvo, Skoda, Всі марки СНД, Азія, Китай", val: 3.861 },
		{ name: "Всі інші марки ТЗ", val: 3.51 },
		{ name: "Nissan, Kia, Suzuki", val: 3.159 }
	],
	l1: [
		{ name: "Mitsubishi, BMW", val: 3.08 },
		{ name: "Всі інші марки ТЗ", val: 2.8 },
		{ name: "Toyota, Volkswagen, Mercedes-Benz, Skoda, Land Rover, Audi, Nissan, Honda, KIA, Volvo", val: 2.52 }
	],
	l2: [
		{ name: "Porsche, Toyota, BMW", val: 2.415 },
		{ name: "Всі інші марки ТЗ", val: 2.3 },
		{ name: "Volkswagen, Land Rover", val: 2.185 }
	]
};
...
function calculate() {
	...
	totalKof = Math.round(totalKof * 100) / 100
...
function sendTelegram() {
	...
	let program = document.querySelector('input[name="program"]:checked').nextSibling.textContent.trim();
